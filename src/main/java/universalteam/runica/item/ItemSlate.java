...
public class ItemSlate extends Item
{
	...
	{
		itemIcon = register.registerIcon("runica:slate");
	}
	...
	{
		if (stack.hasTagCompound() && stack.getTagCompound().hasKey("RunicaLetter"))
			list.add(stack.getTagCompound().getString("RunicaLetter"));
	}
}
